...
sleep 2
pkill -9 sipp
echo "press some char ..."
read a
echo "Starting Callee instances ..."
sipp -t u1 -p 5080 127.0.0.1:5060 -nd -sf ./peers.xml -mp 13300 -s mcptt_02 -m 1 -bg -nostdin
sipp -t u1 -p 5090 127.0.0.1:5060 -nd -sf ./peers.xml -mp 13400 -s mcptt_03 -m 1 -bg -nostdin
