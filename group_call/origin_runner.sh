...
sipp -t u1 -p 5080 127.0.0.1:5060 -nd -sf ./mcptt_client2.xml -s mcptt_02 -m 1 -bg -nostdin
sipp -t u1 -p 5090 127.0.0.1:5060 -nd -sf ./mcptt_client2.xml -s mcptt_03 -m 1 -bg -nostdin

echo "Starting Caller ..."
sipp -t u1 -p 5070 127.0.0.1:5060 -nd -sf ./mcptt_client1.xml -s mcptt_01 -m 1 
